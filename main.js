...
console.log(`backstage info 'Alle uitverkochte televisie's:`);
...
// console.log(`backstage info 'Alle ambilight televisie's': ${JSON.stringify(ambilightTelevisions)}`); //NOTE TO MYSELF: THIS IS A SINGLE-LINE SOLUTION! Yay! 
console.log(`backstage info 'Alle ambilight televisie's:`);
...
console.log(`backstage info 'Prijzen gesorteerd': ${televisionPrices}`);
...
console.log(`backstage info 'De totaalwaarde is:' ${totalValue(inventory)}`);
...
console.log(`backstage info 'De totaalwaarde verkocht is:' ${totalSoldValue(inventory)}`);
...
console.log(`backstage info 'Naam uitgebreid gespecificeerd: ${nameSpecified(inventory[0])}`);
...
console.log(`backstage info 'Nette format van prijs:' ${returnPrice(inventory[1])}`);
...
console.log(`backstage info 'Screen size array:' ${returnSize(inventory[0])}`);
...
document.getElementById("soldOutTelevisions").addEventListener("click", function() {
    console.log('soldOutTelevisions button, results:');
    console.log(televisionsSoldOut);
});